...
function loadGame() {
  ...
  GameProps.sounds.gameIsOver = new libSound.TSoundFile("./Media/gameOver.mp3");
  ...
  switch (GameProps.status) {
    case EGameStatus.playing:
      ...
      for (let i = 0; i < GameProps.obstacles.length; i++) {
        ...
        if (!GameProps.hero.isDead && GameProps.hero.collidesWith(obstacle)) {
      ...
      if (!GameProps.hero.isDead && delObstacleIndex >= 0) {
...
function spawnObstacle() {
  ...
  obstacle.setDayTime(GameProps.dayTime);
